...
describe("App", () => {
  ...
  it("discovers public profiles by custom or ENS identity", async () => {
    ...
    expect(within(ownDirectoryCard).getByText(/as a capital provider/i)).toBeInTheDocument();
    expect(within(ownDirectoryCard).getByText(/as a labor provider/i)).toBeInTheDocument();
